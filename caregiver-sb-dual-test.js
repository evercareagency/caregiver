...
assert.ok(html.includes('<meta name="caregiver-build" content="2026-09-24-sb-recover">'), 'caregiver-build meta');
assert.ok(html.includes('v=sbrecover1'), 'recover probe marker');
