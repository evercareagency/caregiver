...
assert.ok(html.includes('<meta name="caregiver-build" content="2026-09-24-sb-reset">'), 'caregiver-build meta');
assert.ok(html.includes('v=sbreset1'), 'reset probe marker');
